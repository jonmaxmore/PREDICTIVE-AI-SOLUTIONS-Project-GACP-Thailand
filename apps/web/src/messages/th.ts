...
export const messages = {
  ...
  login: {
    title: 'เข้าสู่ระบบ',
    departmentName: 'กรมการแพทย์แผนไทยและการแพทย์ทางเลือก',
    ministryName: 'กระทรวงสาธารณสุข',
    systemName: 'ระบบรับรองมาตรฐานแหล่งผลิต เก็บเกี่ยว และแปรรูปพืชกัญชา (GACP)',
    emblemAlt: 'ตรากรมการแพทย์แผนไทยและการแพทย์ทางเลือก',
    chooseRole: 'เลือกว่าคุณเข้าใช้ในฐานะใด',
    tabsLabel: 'ประเภทผู้ใช้',
    tabApplicant: 'ผู้ขอรับรอง',
    tabStaff: 'เจ้าหน้าที่กรม',
    applicantLead:
      'เกษตรกร วิสาหกิจชุมชน หรือนิติบุคคลที่ยื่นคำขอรับรอง GACP ใช้บัญชี Health ID ของหมอพร้อม หรือ ThaID ของกรมการปกครอง',
    healthId: 'เข้าสู่ระบบด้วย Health ID',
    or: 'หรือ',
    thaid: 'เข้าสู่ระบบด้วย ThaID',
    staffLead:
      'ใช้บัญชี Health ID ที่มี Provider ID ในสังกัดที่กรมอนุญาต ระบบจะพาคุณไปยืนยันตัวตนที่หมอพร้อมแล้วตรวจ Provider ID ให้อัตโนมัติ',
    providerId: 'เข้าสู่ระบบด้วย Provider ID',
    providerIdStepsTitle: 'ยังไม่มี Provider ID? ทำตามนี้',
    providerIdSteps: [
      'มีบัญชี Health ID ของหมอพร้อม (สมัครที่ moph.id.th)',
      'ลงทะเบียน Provider ID ที่ provider.id.th และให้หน่วยงานของคุณรับรอง',
      'แจ้งผู้ดูแลระบบของกรมให้เพิ่มสังกัดของคุณและมอบบทบาท แล้วกลับมาเข้าสู่ระบบอีกครั้ง',
    ],
    noPasswordNote: 'ระบบไม่เก็บรหัสผ่านของคุณ การยืนยันตัวตนทำที่หมอพร้อมหรือกรมการปกครองโดยตรง',
    notConfigured:
